...
#ifndef MJZ_BYTE_STRING_cx_string_ABI_LIB_HPP_FILE_
#define MJZ_BYTE_STRING_cx_string_ABI_LIB_HPP_FILE_
  ...
  struct data_t : abi_ns_::alloc_t<version_v, has_alloc_v_> {
   ...
   public:
    ...
    MJZ_CX_FN success_t add_null() noexcept {
      if (can_add_null<when_v>()) {
        u_get_mut_begin()[get_length()] = '\0';
        cntrl().has_null = true;
        return true;
      }
...
#endif  // MJZ_BYTE_STRING_cx_string_ABI_LIB_HPP_FILE_